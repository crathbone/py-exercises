...
#        avg(numlis)
#            ct = ct + 1
        print("The sum of this list is",sum(numlis))
#        print("The average of this list is",avg(numlis))
#the following print instructions are working as expected
    print()
    print("Check the contents and lengths of the two lists.")
    print()
    print(nlis)
    print("There are",len(nlis),"items in the 'nlis' list.")
    print()
    print(rlis)
    print("There are",len(rlis),"items in the 'rlis' list.")
