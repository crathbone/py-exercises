...
def celsius_to_fahrenheit(temp):
    newtemp=9/5*(temp)+32
    print("Celsius temperature",temp,"is",newtemp,end='')
    print(" degrees Fahrenheit.")
    
#%%
def celsius_to_fahrenheit(temp):
    newTemp2=((9/5)*temp)+32
    print("The Celsius temperature",temp,"degrees is equivalent to",newTemp2,"degrees Fahrenheit.")
"""
End solution
"""
#%%
...
def name():
    ...
    cityname = input("Enter the name of the city that you live in: ")
    statename = input("Enter the name of your state: ")
    placename = cityname +" " + statename
    print("Your name is:", fullname)
    print("The city and state are:", placename)
...
#Begin CR solution: some corrected lines at the end now do work...

"""
Enter and display the name and place, acknowledge the entry and invite the user to check its accuracy
"""
def name_and_place():
    fname=input("What is your first name? ")
    lname=input("And what is your last name? ")
    cname=input("What place do you live in? ")
    sname=input("And what state is that in? ")
    name=(fname+" "+lname)
    place=(cname+", "+sname)
    print("")
    print("Thank you for registering! Now check to see if the name and place are correct.")
    print("")
    print("Your name is:",name)
    print("You live in:",place)
    print("")
    answer=input("If this is correct, enter 1: ")
    print("")
    if answer == "1":
        print("Oh boy, it's correct!")
    else:
...
def absolutevalue(num):
    if (num)>=0:
        print ("The absolute value of", num, "computes to", num)
    else:
        print ("The absolute value of", (num), "computes to", (-num))
"""Parentheses around num in this example have no effect"""
#%%
# Test runs
absolutevalue(5)
absolutevalue(-5)
...
"""
"""
CR solution follows using % to compute a remainder
"""
...
"""
def blastoff():
    """ Counts down from 10 to 1, prints the numbers and prints a message. Note that everything in 
    the while loop is indented. The first line not indented is the first line following the while loop. """
    ct = 10
    while ct >= 1:
        print(ct,end=" ")  # end = " " keeps from starting a new line
        ct = ct -1
...
"""
def favorite():
    '''corrects indentation before print, and corrects my-toy to my_toy'''
    my_toy = input("What is my favorite toy? ")
